...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Memeriksa apakah nilai_awal dan nilai_akhir sudah diatur sebelum mengaksesnya
    if (isset($_POST["nilai_awal"]) && isset($_POST["nilai_akhir"])) {
        ...
        // Pesan kesalahan jika nilai awal atau nilai akhir tidak diisi
        echo "<p>Silakan isi nilai awal dan nilai akhir.</p>";
    }
}
?>
